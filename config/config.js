...
export const PIPEDRIVE_API_KEY = process.env.API_KEY;
export const PIPEDRIVE_BASE_URL = process.env.BASE_URL;
export const GOOGLE_SHEETS_ID = process.env.GOOGLE_SHEETS_ID;
export const GOOGLE_SHEET_NAME = process.env.GOOGLE_SHEET_NAME || 'Deals';
...
export function getFiltersFromEnv() {
    const filters = {};
